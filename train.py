...
@click.option('--arch',          help='Network architecture', metavar='ddpmpp|ncsnpp',              type=click.Choice(['ddpmpp', 'ncsnpp', 'ddpm', 'ncsn']), default='ddpmpp', show_default=True)

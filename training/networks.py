...
#----------------------------------------------------------------------------
# Preconditioning corresponding to the EDM formulation 
# from the paper "Elucidating the Design Space of Diffusion-Based 
# Generative Models".
...
#----------------------------------------------------------------------------
# Fast Diffusion Model with EDM Preconditioning (EDM-FDM)
# from the paper "Elucidating the Design Space of Diffusion-Based 
# Generative Models".
...
class FDM_EDMPrecond(torch.nn.Module):
    def __init__(self,
        ...
        sigma_data      = 0.5,              # Expected standard deviation of the training data.
        model_type      = 'SongUNet',       # Class name of the underlying model.
        fdm_beta_d       = 19.9,            # Extent of the FDM noise level schedule.
        fdm_beta_min     = 0.1,             # Initial slope of the FDM noise level schedule.
        fdm_multiplier   = 1.0,             # Multiplier of the FDM noise level schedule.
        **model_kwargs,                     # Keyword arguments for the underlying model.
    ):
        super().__init__()
        self.img_resolution = img_resolution
    ...
    def s(self, sigma):
        ...
        return torch.exp(-self.fdm_multiplier * beta) * (1. + self.fdm_multiplier * beta)
    

#----------------------------------------------------------------------------
# Fast Diffusion Model with VP Preconditioning (VP-FDM)
# from the paper "Score-Based Generative Modeling through Stochastic
# Differential Equations".
...
#----------------------------------------------------------------------------
# Fast Diffusion Model with VE Preconditioning (VE-FDM)
# from the paper "Score-Based Generative Modeling through Stochastic
# Differential Equations".
